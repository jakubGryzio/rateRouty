...
const BUTTON_TITLE = "Zaloguj";
const NOT_LOGOUT_TITLE = "Pozostań zalogowany";
const PASS_REMAINDER_TITLE = "Zapomniałeś hasła?";
const EMAIL_PLACEHOLDER = "Nazwa użytkownika";
  ...
  return (
    <form onSubmit={submitHandler} className={classes.formContainer}>
      ...
      <div className={classes.loginButtonContainer}>
        <EntryButton disabled={!formIsValid} title={BUTTON_TITLE} />
      </div>
