"""
Django settings for rateRouty project.
...
SECRET_KEY = 'django-insecure-i76f*a77abdhiofn#7#it$iefw0e1=bp6ju0olpgr1%demre_5'
...
WSGI_APPLICATION = 'rateRouty.wsgi.application'
